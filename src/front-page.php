...
<section class="section relative overflow-x-clip">
    ...
    <div class="square hide-max-lg levitate2" style="right: 44px; top: 132px;"></div>
    <div class="square hide-max-lg" style="right: -44px; top: 220px;"></div>
    <div class="square hide-max-lg" style="right: 220px; top: 220px;"></div>
    <div class="square hide-max-lg levitate" style="right: 132px; top: 308px;"></div>
    <div class="square hide-max-lg" style="right: 44px; top: 396px;"></div>
    <div class="square hide-max-lg levitate3" style="right: 132px; top: 484px;"></div>
</section>
...
<section class="section relative">
    ...
    <div class="square levitate" style="right: 88px; top: 220px;"></div>
...
<script>
    ...
    function scrollToForm() {
        document.querySelector('#contact-anchor').scrollIntoView({behavior: 'smooth'});
    }
</script>
