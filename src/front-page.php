        ...
        <div class="row">
            <div class="col-xl-4">
                <div class="d-flex flex-column align-items-center-lg text-align-center-lg h-100">
                    ...
                    <h4 class="font-size-18 font-size-24-lg font-weight-300 mt-35 mb-20"><?php echo get_field('s1_col-1-text-1') ?> <span class="font-weight-700"><?php echo get_field('s1_col-1-text-1-bold') ?></span> <?php echo get_field('s1_col-1-text-2') ?></h4>
                </div>
            </div>
            <div class="col-xl-4 mt-35 mt-0-xl">
                <div class="d-flex flex-column align-items-center-lg text-align-center-lg h-100">
                    ...
                    <h4 class="font-size-18 font-size-24-lg font-weight-300 mt-35 mb-20"><?php echo get_field('s1_col-2-text-1') ?> <span class="font-weight-700"><?php echo get_field('s1_col-2-text-1-bold') ?></span> <?php echo get_field('s1_col-2-text-2') ?></h4>
                </div>
            </div>
            <div class="col-xl-4 mt-35 mt-0-xl">
                <div class="d-flex flex-column align-items-center-lg text-align-center-lg h-100">
                    ...
                    <h4 class="font-size-18 font-size-24-lg font-weight-300 mt-35 mb-20"><?php echo get_field('s1_col-3-text-1') ?> <span class="font-weight-700"><?php echo get_field('s1_col-3-text-1-bold') ?></span> <?php echo get_field('s1_col-3-text-2') ?></h4>
                </div>
            </div>
        </div>
    </div>
