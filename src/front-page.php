        ...
        <div class="row h-100">
            <div class="col-lg-6 h-100">
                <div class="h-100 d-flex flex-column justify-content-center">
                    <h1 class="font-size-36 font-size-60-lg color-white mb-70"><span class="font-weight-300"><?php echo get_field('main_text-1') ?></span> <?php echo get_field('main_text-bold-1') ?></h1>
...
<section class="section relative" style="overflow-x: clip">
    <div class="container">
        <h2 class="font-size-36 font-size-50-lg mb-160 text-align-center-lg"><?php echo get_field('s1_header') ?></h2>
        <div class="row">
            <div class="col-xl-4">
                <div class="d-flex flex-column align-items-center-lg text-align-center-lg h-100">
                    ...
                    <h4 class="font-size-20 font-size-30-lg mt-35 mb-20"><?php echo get_field('s1_col-1-text-1') ?> <span class="font-weight-300"><?php echo get_field('s1_col-1-text-1-bold') ?></span> <?php echo get_field('s1_col-1-text-2') ?></h4>
                </div>
            </div>
            <div class="col-xl-4 mt-70 mt-0-xl">
                <div class="d-flex flex-column align-items-center-lg text-align-center-lg h-100">
                    ...
                    <h4 class="font-size-20 font-size-30-lg mt-35 mb-20"><?php echo get_field('s1_col-2-text-1') ?> <span class="font-weight-300"><?php echo get_field('s1_col-2-text-1-bold') ?></span> <?php echo get_field('s1_col-2-text-2') ?></h4>
                </div>
            </div>
            <div class="col-xl-4 mt-70 mt-0-xl">
                <div class="d-flex flex-column align-items-center-lg text-align-center-lg h-100">
                    ...
                    <h4 class="font-size-20 font-size-30-lg mt-35 mb-20"><?php echo get_field('s1_col-3-text-1') ?> <span class="font-weight-300"><?php echo get_field('s1_col-3-text-1-bold') ?></span> <?php echo get_field('s1_col-3-text-2') ?></h4>
                </div>
            </div>
        </div>
    </div>
    <div class="square" style="right: 44px; top: 132px;"></div>
    <div class="square" style="right: -44px; top: 220px;"></div>
    <div class="square" style="right: 220px; top: 220px;"></div>
    <div class="square" style="right: 132px; top: 308px;"></div>
    <div class="square" style="right: 44px; top: 396px;"></div>
    <div class="square" style="right: 132px; top: 484px;"></div>
</section>


<section class="section bg-grey">
    <div class="container relative">
        <h2 class="font-size-36 font-size-50-lg mb-160"><?php echo get_field('s2_header') ?></h2>
        <div class="row">
            <div class="col-xl-7">
                <div class="card mb-35">
                    <svg width="46" height="46" class="min-width-46 mr-20 mr-35-sm" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 46"><path d="m44.42 43.244-7.604-7.603 5.886-5.886a2.847 2.847 0 0 0 .779-2.688 2.894 2.894 0 0 0-1.845-2.1L19.78 17.141a2.911 2.911 0 0 0-3.818 2.105 2.88 2.88 0 0 0 .112 1.617l7.826 21.84a2.863 2.863 0 0 0 2.1 1.845c.208.05.422.076.636.08a2.895 2.895 0 0 0 2.052-.859l5.885-5.886 7.604 7.604a1.59 1.59 0 0 0 2.242 0 1.59 1.59 0 0 0 0-2.243ZM33.492 34.48l-6.665 6.664-7.572-20.805 20.917 7.476-6.68 6.665ZM34.557 9.06l-6.076 6.061a1.591 1.591 0 1 1-2.259-2.243l6.076-6.076a1.597 1.597 0 1 1 2.259 2.259ZM22.007 2.539v8.59a1.59 1.59 0 1 1-3.181 0v-8.59a1.59 1.59 0 0 1 3.181 0ZM14.595 15.121a1.59 1.59 0 0 1-1.13.477 1.592 1.592 0 0 1-1.13-.477l-6.06-6.06a1.592 1.592 0 0 1 2.243-2.259l6.076 6.076a1.59 1.59 0 0 1 0 2.243ZM12.177 20.943a1.59 1.59 0 0 1-1.591 1.59h-8.59a1.59 1.59 0 0 1 0-3.18h8.59a1.59 1.59 0 0 1 1.59 1.59ZM14.594 29.007l-6.076 6.077a1.592 1.592 0 0 1-2.243 0 1.59 1.59 0 0 1 0-2.243l6.06-6.076a1.59 1.59 0 0 1 2.722 1.12c0 .421-.167.824-.463 1.122Z" fill="#6377FE"/></svg>
                    <div>
                        <h4 class="font-size-24 font-size-30-lg mb-20 color-primary"><?php echo get_field('s2_header-1') ?></h4>
                        <p class="font-size-20 mb-20"><?php echo get_field('s2_text-1') ?></p>
                        <a class="font-size-20 font-weight-700 color-black" href="<?php echo get_field('s2_url-1') ?>"><?php echo get_field('s2_url-text-1') ?> <div class="button-icon"><div class="arrow arrow--button"></div></div></a>
                    </div>
                </div>
                <div class="card mb-35">
                    <svg width="46" height="33" class="min-width-46 mr-20 mr-35-sm" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M37.28.157H5.422A4.528 4.528 0 0 0 .818 4.685v20.088A4.528 4.528 0 0 0 5.42 29.3h31.86a4.527 4.527 0 0 0 4.603-4.527V4.685A4.526 4.526 0 0 0 37.28.157Zm1.585 24.616a1.51 1.51 0 0 1-1.584 1.51H5.42a1.509 1.509 0 0 1-1.51-1.51V11.537H19.05a1.51 1.51 0 1 0 0-3.019H3.836V4.685a1.51 1.51 0 0 1 1.51-1.51H37.28a1.51 1.51 0 0 1 1.584 1.51v20.088Z" fill="#6377FE"/></svg>
                    <div>
                        <h4 class="font-size-24 font-size-30-lg mb-20 color-primary"><?php echo get_field('s2_header-2') ?></h4>
                        <p class="font-size-20 mb-20"><?php echo get_field('s2_text-2') ?></p>
                        <a class="font-size-20 font-weight-700 color-black" href="<?php echo get_field('s2_url-2') ?>"><?php echo get_field('s2_url-text-2') ?> <div class="button-icon"><div class="arrow arrow--button"></div></div></a>
                    </div>
                </div>
                <div class="card mb-35">
                    <svg width="46" height="33" class="min-width-46 mr-20 mr-35-sm" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M40.16.738H5.523A4.922 4.922 0 0 0 .602 5.66v21.838a4.922 4.922 0 0 0 4.922 4.923h34.635a4.922 4.922 0 0 0 4.923-4.922V5.66A4.922 4.922 0 0 0 40.159.738Zm1.64 9.09H25.557l.46-.46a1.64 1.64 0 0 0-2.314-2.313l-4.43 4.43 4.413 4.414a1.643 1.643 0 0 0 2.314 0 1.641 1.641 0 0 0 0-2.314l-.476-.476H41.8V27.5a1.64 1.64 0 0 1-1.64 1.64H5.523a1.64 1.64 0 0 1-1.641-1.64V5.66a1.64 1.64 0 0 1 1.64-1.64H40.16A1.64 1.64 0 0 1 41.8 5.66v4.168Z" fill="#6377FE"/></svg>
                    <div>
                        <h4 class="font-size-24 font-size-30-lg mb-20 color-primary"><?php echo get_field('s2_header-3') ?></h4>
                        <p class="font-size-20 mb-20"><?php echo get_field('s2_text-3') ?></p>
                        <a class="font-size-20 font-weight-700 color-black" href="<?php echo get_field('s2_url-3') ?>"><?php echo get_field('s2_url-text-3') ?> <div class="button-icon"><div class="arrow arrow--button"></div></div></a>
                    </div>
                </div>
            </div>
            <div class="col-xl-5">
                <div class="slider">
                    ...
                    <div class="slider__dots">
                        <?php /*if (get_field('slider_img_2')): */?>
                            ...
                            <div class="arrow arrow--rotate-45"></div>
...
<section class="section relative">
    <div class="container">
        <h2 class="font-size-36 font-size-50-lg mb-160 text-align-center-lg"><?php echo get_field('s3_header') ?></h2>
        <div class="row">
            <div class="col-xl-6">
                <div class="text-align-center-lg h-100 font-size-122 font-size-198-lg color-primary"><?php echo get_field('s3_commission') ?></div>
            </div>
            <div class="col-xl-6 mt-70 mt-0-xl">
                <div class="d-flex flex-column align-items-center-lg text-align-center-lg h-100">
                    ...
                    <h4 class="font-size-20 font-size-30-lg color-primary mt-20 mb-20"><span class="font-weight-300 color-black"><?php echo get_field('s3_text-1') ?></span> <?php echo get_field('s3_text-1-bold') ?> <?php if (get_field('s3_text-2')):?><span class="font-weight-300 color-black"><?php echo get_field('s3_text-2') ?></span><?php endif; ?></h4>
                    <a class="font-size-20 font-weight-700 color-black fit-content" href="<?php echo get_field('s3_link') ?>"><?php echo get_field('s3_link-text') ?> <div class="button-icon"><div class="arrow arrow--button"></div></div></a>
                </div>
            </div>
        </div>
    </div>
...
<section class="section relative bg-grey" style="overflow-x: clip">
    <div class="container">
        <h2 class="font-size-36 font-size-50-lg mb-70"><?php echo get_field('s4_header') ?></h2>
        <div class="row">
            <div class="col-xl-5">
                <div>
                    <p class="font-size-20 font-size-30-lg mt-20 mb-20"><?php echo get_field('s4_text') ?></p>
                    <a class="font-size-20 font-weight-700 color-black" href="<?php echo get_field('s4_link') ?>"><?php echo get_field('s4_link-text') ?> <div class="button-icon"><div class="arrow arrow--button"></div></div></a>
                </div>
            </div>
            <div class="col-xl-7">
    ...
    <div class="dot" style="right: 980px; top: 480px;"></div>
    <div class="dot" style="right: 1350px; top: 560px;"></div>
    <div class="dot" style="right: 1600px; top: 480px;"></div>
</section>


<section class="section">
    <div class="container">
        <h3 class="mb-160 font-size-24 font-size-30-lg font-weight-300 d-flex flex-column-xxl align-items-center text-align-center-xxl"><?php echo get_field('s5_header-1') ?>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="d-flex flex-column align-items-center-lg text-align-center-lg">
                    <h4 class="font-size-24 font-size-30-lg color-primary mb-20"><?php echo get_field('s5_header-2') ?></h4>
                    <p class="font-size-20 mt-20 mb-20"><?php echo get_field('s5_text-1') ?></p>
                    <p class="font-size-20 mt-20"><?php echo get_field('s5_text-2') ?> <a href="<?php echo get_field('s5_help-link') ?>" target="_blank" class="color-primary text-underline"><?php echo get_field('s5_help-link-text') ?></a></p>
                </div>
            </div>
