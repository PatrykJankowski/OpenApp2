        ...
        <div class="row h-100">
            <div class="col-lg-6 h-100 relative">
                <div class="h-100 d-flex flex-column justify-content-center">
                    ...
                    <a href="<?php echo get_field('main_link-1') ?>" class="button"><?php echo get_field('main_link-text-1') ?></a>
                </div>
            </div>
    ...
    <div class="container relative">
        ...
        <div class="row">
            <div class="col-xl-7 d-flex flex-column justify-content-center">
                <div class="card mb-35" onclick="currentSlide(1)">
                ...
                <div class="card mb-35" onclick="currentSlide(2)">
                ...
                <div class="card mb-35 mb-0-xl" onclick="currentSlide(3)">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="d-flex flex-column align-items-center-lg text-align-center-lg">
                    ...
                    <p class="font-size-18 mt-20"><?php echo get_field('s5_text-2') ?> <a href="<?php echo get_field('s5_help-link') ?>" target="_blank" class="color-primary text-underline"><?php echo get_field('s5_help-link-text') ?></a></p>
                </div>
            </div>
